...
async function main() {
  ...
  const student2 = await studentRepo.save({name: '小美', class: class2});
  ...
  await gradeRepo.save({score: 90, student: student1, subject: math});
  await gradeRepo.save({score: 95, student: student1, subject: english});

  await gradeRepo.save({score: 100, student: student2, subject: math});
  await gradeRepo.save({score: 75, student: student2, subject: english});
  // ================================================================================
