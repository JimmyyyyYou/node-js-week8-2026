 ...
 */
module.exports = class Init1786291580829 {
    name = 'Init1786291580829'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "GRADE" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "score" integer NOT NULL, "student_id" uuid, "subject_id" uuid, CONSTRAINT "PK_bd0bb90149430debd6371dd718a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "STUDENT" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(50) NOT NULL, CONSTRAINT "PK_85f0e0a0ccd38f6d8ea17f5e9b1" PRIMARY KEY ("id"))`);
